...
export const FUENTE_VOLTAJE_DEFAULT_PARAMS = Object.freeze({
  activo:        1,
  corriente_max: '5.00',
  dcOrAc:        'dc',
  phase:         '0.00',
...
export class FuenteVoltaje extends Component {
  constructor(args = {}) {
    super({ ...args, type: 'fuente_voltaje' });
  ...
  /** @returns {number} - magnitud en volts */
  get voltaje()      { return parseFloat(this.value) || 0; }
